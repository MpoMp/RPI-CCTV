...
Motion Notify v0.1 - uploads images and video to Google Drive and sends notification via email.
...
hdlr = logging.handlers.RotatingFileHandler( '/tmp/motion-notify.log',
                             maxBytes=1048576,
                             backupCount=3 )
